...
export default async function AdminNotificationsPage({ searchParams }: { searchParams?: Promise<QueryParams> }) {
        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <CardDescription className="max-w-2xl">
              Suivi des événements clés du planning, des matchs et des sondages.
            </CardDescription>
          </div>
